...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Muks & Khush Interior — Crafting Timeless Spaces Across Rwanda" },
      { property: "og:description", content: "Full-service construction and interior design studio based in Kigali. Villas, commercial spaces, renovations, modular interiors." },
